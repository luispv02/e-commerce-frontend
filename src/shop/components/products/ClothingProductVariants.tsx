                    ...
                    <div className="flex flex-wrap gap-2">
                      {
                        product.sizes.map((size) => (
                          <button 
                            ...
                            className={`border px-3 py-1 rounded text-gray-700 uppercase transition-all ${size === productVariant.selectedSize ? 'bg-black text-white' : 'border-gray-300'} ${product.stock === 0 ? 'opacity-55' : 'cursor-pointer hover:shadow-md' }`} 
                    ...
                    <div className="flex flex-wrap gap-2">
                      {
                        availableColors.map(color => (
                          <button
                            ...
                            className={`px-4 py-1 rounded-full text-xs font-medium transition-all flex items-center gap-2 ${product.stock === 0 ? 'opacity-55' : 'cursor-pointer hover:shadow-md' } ${color.id === productVariant.selectedColor
                              ? "border shadow-md"
