    ...
    <>
      <div className="flex-1 flex items-center justify-center px-6 lg:px-0">
        <div className="w-full max-w-md backdrop-blur-md bg-white/10 rounded-3xl shadow-xl  border border-white/30 px-6 md:px-8 py-10">
          ...
          <h2 className="text-3xl font-bold text-white mb-8 drop-shadow-lg text-center">Registrate ahora</h2>
          ...
          <div className="mt-8 text-center">
            <p className="text-white text-sm drop-shadow-md">
              ¿Ya tienes cuenta?{" "}
              <Link to="/auth/login" className="text-white font-semibold hover:text-white/80 transition-colors underline underline-offset-2">
                Inicia sesión
              </Link>
            </p>
          </div>
